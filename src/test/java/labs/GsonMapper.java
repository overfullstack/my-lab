...
class GsonMapper {
    ...
    void testDeepCloneListOfBeans() {
        ...
        var bean1 = new Bean("1", "1", Collections.emptyList());
        var bean2 = new Bean("2", "2", Collections.emptyList());
        var bean3 = new Bean("3", "3", Collections.emptyList());
        beans.add(bean1);
        beans.add(bean2);
        beans.add(bean3);
        System.out.println(beans);

        var beanListType = new TypeToken<ArrayList<Bean>>() {
        }.getType();

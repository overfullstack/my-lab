...
val nameArg =
  Tool.Arg.string().required("name", "Name of the person whose diary appointments are requested")
...
fun toolDefinitionFor(): Tool =
  Tool("diary", "Responds with a list of appointments for the given date", nameArg, dateArg)
...
val diaryToolHandler: ToolHandler = { toolRequest ->
  ...
  val calendarData =
    mapOf(date to listOf("08:00 - Breakfast meeting", "11:00 - $name PTM", "16:00 - Tour planner"))
